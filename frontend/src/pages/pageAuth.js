        ...
        <div className="page-auth">
            <div className="auth-card">
                <div className="auth-inner">
                    ...
                    <h1 className="auth-title">{isSignUp ? 'ลงทะเบียน' : 'ลงชื่อเข้าใช้'}</h1>
                    <p className="auth-sub">{isSignUp ? 'ลงทะเบียนสำหรับสร้างบัญชี' : 'ลงชื่อเพื่อเข้าใช้งานก่อนนะ !'}</p>
                    ...
                    <button type="button" className="gsi-material-button google-btn" onClick={handleGoogle} disabled={loading}>
                        ...
                        <div className="gsi-material-button-content-wrapper">
                            ...
                            <span className="gsi-material-button-contents">ดำเนินการต่อด้วย Google</span>
